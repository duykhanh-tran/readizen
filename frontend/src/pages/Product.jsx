...
export default function Product() {
  ...
  return (
    <div className="font-sans text-gray-800 bg-brand-cream min-h-screen selection:bg-brand-light/40 overflow-x-hidden">
      ...
      {/* ================= SECTION 1: HERO ================= */}
      <header
        className="relative w-full py-16 lg:py-24 min-h-[680px] flex items-center overflow-hidden font-sans text-left"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-3xl text-left z-10">
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold text-gray-900 leading-tight mb-6 tracking-tight">
                Bộ 5 cuốn Readize đầu tiên để con bắt đầu luyện đọc tại nhà
              </h1>
              <p className="text-xl lg:text-2xl text-gray-800 mb-6 max-w-2xl leading-relaxed font-medium">
                Readizen Set 1 giúp trẻ 5+ bắt đầu đọc truyện tiếng Anh tại nhà bằng 5 câu chuyện phù hợp trình độ, với sự hỗ trợ của App và Giáo viên thực.
              </p>

              {/* Price Box */}
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 inline-flex items-center gap-4 mb-8">
                <span className="font-bold text-xl text-gray-900">290.000đ <span className="text-sm font-normal text-gray-600">/ Set 1</span></span>
                <div className="w-px h-6 bg-yellow-300"></div>
                <div className="flex flex-col">
                  <span className="text-xs text-gray-500 line-through">450.000đ nếu mua lẻ</span>
                  <span className="text-xs font-bold text-orange-600">Tiết kiệm 160.000đ</span>
                </div>
              </div>
